...
$$
\begin{align*}
\text{hospitals}                                 \rightarrow \; & \sigma^2_{v0} = 0.403^2 = 0.162\\
...
```{r}
0.489 / (0.162 + 0.489 + 0.301) # middle level (wards)
0.301 / (0.162 + 0.489 + 0.301) # top level (hospitals)
```
...
There is evidence this intervention lowered stress among nurses working in small hospitals only.
