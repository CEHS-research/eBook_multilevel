...
```{block type='rmdlightbulb', echo=TRUE}
The warning about **"Model is nearly unidentifiable: large eigenvalue ratio - Rescale variables?"** is sa suggestion, not an error.  You can trust the results, but you might want to look into rescaling your variables.
```
