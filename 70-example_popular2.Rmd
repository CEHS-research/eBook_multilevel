...
$$
\overbrace{Y_{ij}}^{\text{outcome}} = 
         \underbrace{\beta_{0}}_{\text{fixed intercept}} + 
         \underbrace{\beta_{1}}_{\text{fixed slope for } X_1} \overbrace{X_{1ij}}^{\text{predictor 1}} + 
         \underbrace{\beta_{2}}_{\text{fixed slope for } X_2} \overbrace{X_{2ij}}^{\text{predictor 2}} + 
         \underbrace{e_{ij}}_{\text{random residuals}} 
\tag{Hox Eq 2.1}
$$
```
...
| Fixed  | Slope of $X_1$                  | $\beta_{1}$    |
| Fixed  | Slope of $X_2$                  | $\beta_{2}$    |
...
$$
POP_{ij} = \overbrace{\beta_{0}}^{intercept} + \underbrace{e_{ij}}_{\text{residuals}}
$$
```
...
|  Type  | Parameter of Interest           | Estimates This |
|--------|:--------------------------------|----------------|
| Fixed  | Intercept, Grand Mean           | $\beta_{0}$    |
| Random | Residual Variance $var[e_{ij}]$ | $\sigma^2_{e}$ |
