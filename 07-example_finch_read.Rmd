...
texreg::screenreg(list(fit_read_lm_0, 
                       fit_read_lm_1, 
                       fit_read_lm_2, 
                       fit_read_lm_3),
...
```{r regLM, echo=FALSE, results='asis'}
...
```{r mlmNull, echo=FALSE, results='asis'}
texreg::htmlreg(list(fit_read_lm_0, 
                     fit_read_0ml, 
                     fit_read_0re),
                custom.model.names = c("OLS", 
...
texreg::screenreg(list(fit_read_0ml, 
                       fit_read_1ml),
                  custom.model.names = c("Null", 
                                         "w Pred"),
...
Or use the `sjstats` package to help out:  (Note it is using a difference method...)
...
texreg::screenreg(list(fit_read_1ml, 
                       fit_read_2ml, 
                       fit_read_3ml),
...
texreg::screenreg(list(fit_read_3re, 
                       fit_read_5re),
...
texreg::screenreg(list(fit_read_3ml, 
                       fit_read_6ml, 
                       fit_read_7ml,
                       fit_read_8ml),
...
texreg::screenreg(list(fit_read_9ml, 
                       fit_read_10ml, 
                       fit_read_9ml_c, 
                       fit_read_10ml_c),
...
texreg::screenreg(list(fit_read_10ml_s, 
                       fit_read_11ml_s, 
                       fit_read_12ml_s),
...
```{r}
fit_read_11re_s <- lmerTest::lmer(geread ~ gevocab_c*age_c + gevocab_c*ses_t +   # 2 2-way interactions
                                    (gevocab_c | school),  
                                  data   = data_achieve_center_scale,
                                  REML   = TRUE)
```
...
texreg::screenreg(list(fit_read_11re_s),
...
```{r}
performance::r2(fit_read_11re_s)
```
