...
```{r}
data_raw <- read.table("https://raw.githubusercontent.com/CEHS-research/eBook_multilevel/master/data/exercise_diet.txt?token=AScXBY80grQdF66G9yRwtPX2qTXK86WLks5bxltawA%3D%3D",
                  header = TRUE, 
                  sep = ",")
```
